  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      Scaffold(
          ...
          builder: (BuildContext context, state) {
            return state.maybeWhen(
              ...
              success: (data) {
                ...
                allProducts = data.data!.data!.data!.products!.data!.where((element) => element.brand_id == brands[selectedBrandIndex].id,).toList();
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView.separated(
                                            ...
                                            itemBuilder: (context, index) {
                                              return InkWell(
                                                onTap: (){
                                                  print(brands[index].name);
                                                  print(brands[index].id);
                                                  setState(() {
                                                    selectedBrandIndex = index;
                                                    allProducts = allProducts.where((element) => element.brand_id == brands[index].id).toList();
        ...
        onWillPop: () async{
          await StorageHelper(_storage).resetFilterStates();
          // context.router.pop();
          return true;
        },
    );
