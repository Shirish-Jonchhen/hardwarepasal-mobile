...
class RecentlyViewedScreenPage extends StatefulWidget {
  const RecentlyViewedScreenPage({super.key});

  @override
  State<RecentlyViewedScreenPage> createState() => _RecentlyViewedScreenPageState();
}

class _RecentlyViewedScreenPageState extends State<RecentlyViewedScreenPage> {
  bool isGrid = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocConsumer<HomeRecentlyViewedCubit, HomeRecentlyViewedState>(
