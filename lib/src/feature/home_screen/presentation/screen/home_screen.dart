...
class _HomeScreenState extends State<HomeScreenPage> {
  ...
  List<Map<String, dynamic>> apCategory = [
    ...
    {"name": "Power", "slug": "power-tools"},
    {"name": "Heater", "slug": "heater"},
    {"name": "Electrical", "slug": "electrical-tool"}
  ];
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            CachedNetworkImage(
                                                                          imageUrl:
                                                                              '${StringHelper.brandImageBastUrl}${data.data!.data![index].image!}',
                                                                          placeholder: (context, url) => const Shimmer(
                                                                              child: Icon(Icons
                                                                                  .downloading_outlined),
          ...
          builder: (BuildContext context) {
            return AlertDialog(
              ...
              insetPadding: EdgeInsets.symmetric(
                  horizontal: 16, vertical: 8), // Reduce dialog margin
              contentPadding:
