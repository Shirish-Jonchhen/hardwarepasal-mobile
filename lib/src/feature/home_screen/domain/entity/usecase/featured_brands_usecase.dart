...
@lazySingleton
class FeaturedBrandsUsecase extends UseCase<ApiResponse<FeaturedBrandsModel>, NoParams>{
  final HomeRepository _homeRepository;
  FeaturedBrandsUsecase(this._homeRepository);

  @override
  Future<Either<AppError, ApiResponse<FeaturedBrandsModel>>> call(NoParams params) => _homeRepository.getFeaturedBrands();
