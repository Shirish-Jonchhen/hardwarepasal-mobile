...
_$ClearanceSaleLinkModelImpl _$$ClearanceSaleLinkModelImplFromJson(
...
Map<String, dynamic> _$$ClearanceSaleLinkModelImplToJson(
        _$ClearanceSaleLinkModelImpl instance) =>
    <String, dynamic>{
      'url': instance.url,
...
_$ClearanceSaleModelImpl _$$ClearanceSaleModelImplFromJson(
        Map<String, dynamic> json) =>
    _$ClearanceSaleModelImpl(
...
Map<String, dynamic> _$$ClearanceSaleModelImplToJson(
        _$ClearanceSaleModelImpl instance) =>
    <String, dynamic>{
