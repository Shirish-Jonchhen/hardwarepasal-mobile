...
class _$ProductSupplierModelImpl implements _ProductSupplierModel {
  ...
  @override
  String toString() {
    return 'ProductSupplierModel(id: $id, name: $name, description: $description, slug: $slug, status: $status, created_by: $created_by, updated_by: $updated_by, created_at: $created_at, updated_at: $updated_at, markup_percent: $markup_percent, code: $code, phone: $phone, email: $email)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.markup_percent, markup_percent) ||
                other.markup_percent == markup_percent) &&
