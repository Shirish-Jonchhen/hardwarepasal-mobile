...
class FeaturedProductsScreenPage extends StatefulWidget {
  const FeaturedProductsScreenPage({super.key, required this.products});
  final List<ProductModel> products;

  @override
  State<FeaturedProductsScreenPage> createState() => _FeaturedProductsScreenPageState();
}

class _FeaturedProductsScreenPageState extends State<FeaturedProductsScreenPage> {
